                ...
                <tbody>
                    @foreach($all_category_product as $key => $cate_pro)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit_category_product', ['id' => $cate_pro->category_id]) }}" class="active styling-edit">
                                    <i class="fa fa-pencil-square-o text-success text-active"></i>
                                </a>
                                <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này không?')" 
                                   href="{{ route('delete_category_product', ['id' => $cate_pro->category_id]) }}" class="active styling-edit">
